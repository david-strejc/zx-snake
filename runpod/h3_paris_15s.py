...
SEED=1234
PROMPT=("A woman sits at a marble bistro table on a Paris cafe terrace in morning light. "
        "She breathes naturally, blinks, shifts her gaze from the street back toward the camera "
        "with a soft smile, lowers her hand from her chin, reaches for the espresso cup, lifts it "
        "and takes a small sip, then sets it down and tucks a loose strand of hair behind her ear. "
        "Subtle head and shoulder movement, hair stirring in a light breeze, pedestrians walking "
        "past in the blurred background, awning fabric moving gently, warm sunlight flickering "
        "through leaves. Handheld vertical phone video, very slow subtle push in, photorealistic "
        "skin and fabric, natural documentary footage. Ambient Paris street sound: distant traffic, "
        "cafe chatter, cups clinking. No speech.")
...
p={
 ...
 "200":N("LoadImage",image="paris_start.png"),
 ...
 "141":N("PrimitiveFloat",value=15.0),
 ...
 "201":N("SaveVideo",video=["138",0],filename_prefix="paris_15s",format="auto"),
}
...
print("prompt_id",r["prompt_id"]); open("/workspace/paris_pid.txt","w").write(r["prompt_id"])
